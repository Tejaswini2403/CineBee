...
},
{
  ...
  ngOnInit(): void {
    ...
    this.actionArray = this.chunk(this.Telugu)
    this.dramaArray = this.chunk(this.Telugu)
    this.comedyArray = this.chunk(this.Telugu)
    this.crimeArray = this.chunk(this.Telugu)
    this.thrillerArray = this.chunk(this.Telugu)
    this.romanceArray = this.chunk(this.Telugu)
    this.trendingArray = this.chunk(this.Telugu)
  }
